...
/**
 * @hooked YITH_WooCommerce_Gift_Cards::include_css_for_emails() Add CSS style to gift card emails header
 */
...
/**
 * @hooked YITH_WooCommerce_Gift_Cards::add_footer_information() Output the email footer
 */
